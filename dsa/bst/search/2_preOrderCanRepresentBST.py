...
def canRepresentBST(pre):
  ...
  for value in pre:
    # NOTE:value is equal to pre[i] according to the given algo
...
print "true  - [40 , 30 , 35 , 80 , 100]" if canRepresentBST(pre1) == True else "false"
pre2 = [40 , 30 , 35 , 20 , 80 , 100]
print "true" if canRepresentBST(pre2) == True else "false - [40 , 30 , 35 , 20 , 80 , 100]"
